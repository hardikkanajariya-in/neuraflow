...
export const metadata: Metadata = {
  ...
  description: 'Learn how NeuraFlow collects, uses, and protects your personal data.',
};
  ...
  return (
    <div className="pt-24 pb-20">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <h1 className="mb-4 text-4xl font-bold text-gray-900 dark:text-white font-display">Privacy Policy</h1>
        <p className="mb-10 text-sm text-gray-400">Last updated: March 1, 2026</p>

        <div className="space-y-8">
          {legalData.privacy.sections.map((section, i) => (
            <div key={i}>
